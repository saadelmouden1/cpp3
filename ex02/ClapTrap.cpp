...
void ClapTrap::attack(const std::string& target)
{
    ...
    else if(hitPoint == 0)
    {
        ...
        std::cout<<"ClapTrap "<<this->Name <<" has no enrgy left to attack"<<std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        std::cout<<"ClapTrap "<<this->Name <<" has no hit points left to repaire"<<std::endl;
    }
    else    
        std::cout<<"ClapTrap "<<this->Name <<" has no enrgy left to repaire"<<std::endl;
